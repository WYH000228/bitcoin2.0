...
class BITCOIN2SignRawSenderTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Now send some bitcoin2 to both addresses (one contract will increase its balance and the other one will throw),
...
if __name__ == '__main__':
    BITCOIN2SignRawSenderTest().main()
