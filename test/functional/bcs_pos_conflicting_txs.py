...
"""
class BITCOIN2POSConflictingStakingMempoolTxTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Allow the bitcoin2 staker some time to run (since we set a mocktime the time will not advance)
        time.sleep(80)
...
if __name__ == '__main__':
    BITCOIN2POSConflictingStakingMempoolTxTest().main()