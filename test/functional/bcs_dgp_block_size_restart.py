...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see bitcoin2-dgp.py
"""
class BITCOIN2DGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the bitcoin2d to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    BITCOIN2DGPActivation().main()
