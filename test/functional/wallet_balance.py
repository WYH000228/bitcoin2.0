...
from test_framework.bitcoin2config import INITIAL_BLOCK_REWARD, COINBASE_MATURITY

RANDOM_COINBASE_ADDRESS = convert_btc_address_to_bitcoin2('mneYUmWYsuk7kySiURxCi3AGxrAqZxLgPZ')
...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("We use a third node here that sends 50 bitcoin2 to each of the two other nodes to keep compatibility with bitcoin")
