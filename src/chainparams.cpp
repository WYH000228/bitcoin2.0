...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // bitcoin2
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // bitcoin2
    return genesis;
}
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 999999999; // bitcoin2 halving every 1 year
        ...
        consensus.nMinimumChainWork = uint256S("0x001"); // bitcoin2
...
public:
    CTestNetParams() {
        strNetworkID = "test";
        consensus.nSubsidyHalvingInterval = 250000; // bitcoin2 halving every 1 year
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00"); // bitcoin2
        ...
        //vSeeds.emplace_back("bitcoin24.dynu.net"); // BITCOIN2testnet
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.BIP34Height = 0; // BIP34 has not activated on regtest (far in the future so block v1 are not rejected in tests) // activate for bitcoin2
...
public:
    ...
    : CRegTestParams(args)
    {
        ...
        // BITCOIN2have 500 blocks of maturity, increased values for regtest in unit tests in order to correspond with it
