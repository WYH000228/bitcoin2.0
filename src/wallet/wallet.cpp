...
void CWallet::StakeBITCOIN2s(bool fStake, CConnman* connman)
{
    ::StakeBITCOIN2s(fStake, this, connman, stakeThread);
}

void CWallet::StartStake(CConnman *connman)
{
    m_enabled_staking = false;
    StakeBITCOIN2s(true, connman);
}
