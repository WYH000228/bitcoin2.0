...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoin2-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoin2-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoin2 transaction\n" +
            "or:     bitcoin2-tx [options] -create [commands]   Create hex-encoded bitcoin2 transaction\n" +
            "\n";
