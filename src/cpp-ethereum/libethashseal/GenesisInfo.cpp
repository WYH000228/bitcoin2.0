...
#include "genesis/bitcoin2MainNetwork.cpp"
...
#include "genesis/test/bitcoin2TestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::bitcoin2MainNetwork: return c_genesisInfoBITCOIN2MainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::bitcoin2TestNetwork: return c_genesisInfoBITCOIN2TestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::bitcoin2MainNetwork: return c_genesisStateRootBITCOIN2MainNetwork;
    case Network::bitcoin2TestNetwork: return c_genesisStateRootBITCOIN2TestNetwork;
