...
class BITCOIN2Style : public QProxyStyle
{
public:
    BITCOIN2Style()
    {
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    BITCOIN2Style* bitcoin2Style = new BITCOIN2Style;
    bitcoin2Style->setBaseStyle(mainStyle);
    app->setStyle(bitcoin2Style);
...
{
    return QStringList() << "BITCOIN2official theme" << "Light blue theme" << "Dark blue theme" << "Dark theme";
}
