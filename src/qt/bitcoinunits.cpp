...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BTC2");
    case mBTC: return QString("mBITCOIN2");
    case uBTC: return QString::fromUtf8("μBITCOIN2(bits)");
...
QString BitcoinUnits::description(int unit)
{
    ...
    case mBTC: return QString("Milli-BITCOIN2s (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-BITCOIN2s (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
