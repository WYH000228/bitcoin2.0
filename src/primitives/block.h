...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // bitcoin2
        hashUTXORoot.SetNull(); // bitcoin2
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //bitcoin2
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //bitcoin2
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //bitcoin2
    {
