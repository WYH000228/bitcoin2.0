...
*Setup instructions for a Gitian build of BITCOIN2Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the BTC2
...
- [Building BITCOIN2Core](#building-bitcoin2-core)
...
git clone https://github.com/cryptofugu/bitcoin2chain-core --recursive
...
```bash
sudo cp /home/debian/bitcoin2chain-core/contrib/gitian-descriptors/xenial /usr/share/debootstrap/scripts
```
...
Building BITCOIN2Core
----------------

To build BITCOIN2Core (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/bitcoin2chain-core/.git/
...
For example:
```bash
URL=https://github.com/cryptofugu/bitcoin2chain-core.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit bitcoin2chain-core=${COMMIT} --url bitcoin2chain-core=${URL} ../bitcoin2chain-core/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit bitcoin2chain-core=${COMMIT} --url bitcoin2chain-core=${URL} ../bitcoin2chain-core/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit bitcoin2chain-core=${COMMIT} --url bitcoin2chain-core=${URL} ../bitcoin2chain-core/contrib/gitian-descriptors/gitian-osx.yml
# if wanting to use a different version of eth-cpp-bitcoin2:
./bin/gbuild --commit bitcoin2chain-core=${COMMIT},cpp-eth-bitcoin2=${ETHCOMMIT} --url bitcoin2chain-core=${URL},cpp-eth-bitcoin2=${ETHURL} ../bitcoin2chain-core/contrib/gitian-descriptors/gitian-linux.yml
```
...
LXC_ARCH=amd64 LXC_SUITE=trusty on-target -u root \
  ...
  $( sed -ne '/^packages:/,/[^-] .*/ {/^- .*/{s/"//g;s/- //;p}}' ../bitcoin2chain-core/contrib/gitian-descriptors/*|sort|uniq )
...
cd /some/root/path/
git clone https://github.com/cryptofugu/bitcoin2-detached-sigs.git

BTCPATH=/some/root/path/bitcoin2chain-core
SIGPATH=/some/root/path/bitcoin2-detached-sigs

./bin/gbuild --url bitcoin2chain-core=${BTCPATH},signature=${SIGPATH} ../bitcoin2chain-core/contrib/gitian-descriptors/gitian-win-signer.yml
```
